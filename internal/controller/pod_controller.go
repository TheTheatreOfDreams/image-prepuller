...
// +kubebuilder:rbac:groups=prepuller.theatreofdreams.dev,resources=images,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups=prepuller.theatreofdreams.dev,resources=images/status,verbs=get;update;patch
